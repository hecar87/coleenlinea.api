...
class SearchEnrollmentByStudentAction
{
	...
	public function execute(int $Id_Student, SearchEnrollmentByStudentDTO $oData) : Result
	{
		//------------------------------------------------------------------------------
		//	VARIABLES
		//------------------------------------------------------------------------------
		...
		try
		{
			...
			$oResult = $this->oEnrollmentRepository->searchByStudent($Id_Student, $oData);
			if ( $oResult->RESULT_STS <> 200 ){ DB::rollBack(); return $oResult; }
